...
#COPY --chown=steamuser --chmod=0755 demo/dx9_demo.exe /home/steamuser/cqds/drive_c/users/steamuser/
#COPY --chown=steamuser --chmod=0755 demo/test.bmp /home/steamuser/cqds/drive_c/users/steamuser/
